...
class WeiboSpider(Spider):
    ...
    def read_src_from_db(self):
        connect = MySQLdb.connect(user=db_user, passwd=db_pass, db=db_name, host=db_host, charset="utf8",
                                       use_unicode=True)
